...
homeLibrary.finishReading("The Revisionists");
homeLibrary.startReading("American Gods");
homeLibrary.finishReading("American Gods");
homeLibrary.startReading("The Eire Affair");
homeLibrary.finishReading("The Eire Affair");
